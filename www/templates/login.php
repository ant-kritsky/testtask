<h3><?php echo _('You can') ?> <?php echo _('enter') ?> <?php echo _('or') ?> <a
            href="/registration"><?php echo _('registration') ?></a></h3>
...
<form method="post" id="login" action="/login">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            <input class="form-control" placeholder="<?php echo _('Insert your email') ?>" id="email" name="email"
                   type="text"/>
        </div>
    </div>
