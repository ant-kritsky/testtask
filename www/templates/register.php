...
<form method="post" id="register" action="" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            <input class="form-control" placeholder="<?php echo _('Insert your name') ?>" value="<?php echo $this->getPost('name') ?>" id="name" name="name" type="text"/>
            <?php if($errors['name']): ?>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            <input class="form-control" placeholder="<?php echo _('Insert your email') ?>" value="<?php echo $this->getPost('email') ?>" id="email" name="email" type="text"/>
            <?php if($errors['email']): ?>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            <input class="form-control" placeholder="<?php echo _('Insert your avatar') ?>" value="<?php echo $this->getPost('email') ?>" id="file" name="file" type="file"/>
            <?php if($errors['file']): ?>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            <input class="form-control" placeholder="<?php echo _('Insert your password') ?>" value="<?php echo $this->getPost('password') ?>" id="password" name="password" type="password"/>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            <input class="form-control" placeholder="<?php echo _('Insert password again') ?>" value="<?php echo $this->getPost('password_again') ?>" id="password_again" name="password_again" type="password"/>
